import {Sun , Contrast, Droplet, Sparkles, RotateCw, ImageIcon, X, Palette, Wand2} from "lucide-react"
            ...
            {setSidebarView && (
                <>
                    <button
                        ...
                        className="w-full mb-4 px-4 py-3 rounded-lg transition-all flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600"
                    >
                        <Palette size={18} />
